    ...
    public void work() throws InterruptedException {
        ...
        while(true){
           ...
           for(int i = 0 ; i < xSize ; i++){
               if(knownMap[upBorder][i] != Types.PASSED && map[upBorder][i] != Types.OBSTACLE){
                    break;
               }
               for(int j = 0 ; j < xSize ; j++){
                   knownMap[upBorder][j] = Types.BORDER;
               }
               upBorder++;
           }
            ...
            for(int i = 1 ; i < ySize ; i++){
                for(int j = 1 ; j < xSize ; j++){
                    if(knownMap[i][j] == Types.GOING_HOME){
                        goHome[i-1][j] = knownMap[i-1][j] == Types.PASSED || knownMap[i-1][j] == Types.OBSTACLE || knownMap[i-1][j] ==  Types.NONE ? -1 : ++d;
                        goHome[i+1][j] = knownMap[i+1][j] == Types.PASSED || knownMap[i+1][j] == Types.OBSTACLE || knownMap[i+1][j] ==  Types.NONE ? -1 : ++d;
                        goHome[i][j-1] = knownMap[i][j-1] == Types.PASSED || knownMap[i][j-1] == Types.OBSTACLE || knownMap[i][j-1] ==  Types.NONE ? -1 : ++d;
                        goHome[i][j+1] = knownMap[i][j+1] == Types.PASSED || knownMap[i][j+1] == Types.OBSTACLE || knownMap[i][j+1] ==  Types.NONE ? -1 : ++d;
                    }
