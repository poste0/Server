...
// Set the seed for the random number generator using the system
clock();
curandSetPseudoRandomGeneratorSeed(prng, (unsigned long long)
clock());
...
nr_rows_A = nr_cols_A = nr_rows_B = nr_cols_B = nr_rows_C = nr_cols_C
= 3;
